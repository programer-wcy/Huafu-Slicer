...
#define SLIC3R_APP_FULL_NAME "HUAFU Slicer"
#define GCODEVIEWER_APP_NAME "HUAFUSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "HUAFUSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("HUAFUSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
