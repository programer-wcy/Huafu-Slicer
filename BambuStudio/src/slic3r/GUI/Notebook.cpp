...
void ButtonsListCtrl::SetSelection(int sel)
{
    ...
    wxColour selected_btn_bg("#005AB5");    // Gradient #00AE42
    if (m_selection >= 0) {
    ...
    StateColor bg_color = StateColor(
        std::pair{wxColour(0,90,181), (int) StateColor::Hovered},//dlut 0,174,66
        std::pair{wxColour(0,90,181), (int) StateColor::Normal});//dlur 0 174 66
    m_pageButtons[m_selection]->SetBackgroundColor(bg_color);
