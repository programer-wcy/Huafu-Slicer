    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(30, 144, 255), StateColor::Pressed);
    border_color.append(wxColour(0,191,255), StateColor::Hovered);
    border_color.append(0x005AB5, StateColor::Normal);
    ...
    background_color.append(wxColour(30, 144, 255), StateColor::Pressed);
    background_color.append(wxColour(0, 191, 255), StateColor::Hovered);
    background_color.append(0x005AB5, StateColor::Normal);
